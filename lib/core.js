...
var Model = function (name, config, controller, dbConf) {
    ...
    var baseUrl = '/' + this.alias + this.name;
    var _self = this;
    ...
    this.route = {
        _create: {
            ...
            handler: function * (next) {
                ...
                try {
                    var res = yield _self.controller._create.call(this, next, param);
        ...
        _read: {
            ...
            handler: function*(next) {
                try {
                    var res = yield _self.controller._read.call(this, next, this.params.id);
                    mt.sendRes.call(this, res);
                } catch (e) {
                    mt.ReqError.call(500);
                    log('koa-restful', "can't find the controller");
        ...
        _readByQuery: {
            ...
            handler: function*(next) {
                ...
                try {
                    var res = yield _self.controller._readByQuery.call(this, next, next, param);
                    mt.sendRes.call(this, res);
                } catch (e) {
                    mt.ReqError.call(500);
                    log('koa-restful', "can't find the controller");
        ...
        _update: {
            ...
            handler: function*(next) {
                ...
                try {
                    var res = yield _self.controller._update.call(this, next, this.params.id, updates);
                    mt.sendRes.call(this, res);
                } catch (e) {
                    mt.ReqError.call(500);
                    log('koa-restful', "can't find the controller");
        ...
        _updateByQuery: {
            ...
            handler: function*(next) {
                ...
                var updates = this.request.body.fields;
                try {
                    var res = yield _self.controller._updateByQuery.call(this, next, query, updates);
                    mt.sendRes.call(this, res);
                } catch (e) {
                    mt.ReqError.call(500);
                    log('koa-restful', "can't find the controller");
        ...
        _delete: {
            ...
            handler: function*(next) {
                try {
                    var res = yield _self.controller._delete.call(this, next, this.params.id);
                    mt.sendRes.call(this, res);
                } catch (e) {
                    mt.ReqError.call(500);
                    log('koa-restful', "can't find the controller");
        ...
        _deleteByQuery: {
            ...
            handler: function*(next) {
                var param = this.request.query;
                try {
                    var res = yield _self.controller._deleteByQuery.call(this, next, param);
                    mt.sendRes.call(this, res);
                } catch (e) {
                    mt.ReqError.call(500);
                    log('koa-restful', "can't find the controller");
