        ...
        this.route = {
            _create: {
                ...
                handler: function * () {
                    ...
                    try{
                        var res = yield _self.controller._create(param);
            ...
            _read: {
                ...
                handler: function*() {
                    try{
                        var res = yield _self.controller._read(this.params.id);
                        mt.sendRes.call(this, res);
                    }catch(e){
                        mt.ReqError.call(500);
                        log('koa-restful',"can't find the controller");
            ...
            _readByQuery: {
                ...
                handler: function*() {
                    ...
                    try{
                        var res = yield _self.controller._readByQuery(param);
                        mt.sendRes.call(this, res);
                    }catch(e){
                        mt.ReqError.call(500);
                        log('koa-restful',"can't find the controller");
            ...
            _update: {
                ...
                handler: function*() {
                    ...
                    try{
                        var res = yield _self.controller._update(this.params.id, updates);
                        mt.sendRes.call(this, res);
                    }catch(e){
                        mt.ReqError.call(500);
                        log('koa-restful',"can't find the controller");
            ...
            _updateByQuery: {
                ...
                handler: function*() {
                    ...
                    var updates = this.request.body.fields;
                    try{
                        var res = yield _self.controller._updateByQuery(query, updates);
                        mt.sendRes.call(this, res);
                    }catch(e){
                        mt.ReqError.call(500);
                        log('koa-restful',"can't find the controller");
            ...
            _delete: {
                ...
                handler: function*() {
                    try{
                        var res = yield _self.controller._delete(this.params.id);
                        mt.sendRes.call(this, res);
                    }catch(e){
                        mt.ReqError.call(500);
                        log('koa-restful',"can't find the controller");
            ...
            _deleteByQuery: {
                ...
                handler: function*() {
                    var param = this.request.query;
                    try{
                        var res = yield _self.controller._deleteByQuery(param);
                        mt.sendRes.call(this, res);
                    }catch(e){
                        mt.ReqError.call(500);
                        log('koa-restful',"can't find the controller");
