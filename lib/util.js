...
var mu = {
    ...
    checkSchema: function(param, schema){
        ...
        for( var key in schema ){
            var checkedField = mu.checkSingleField( reqData[key], schema[key] );
...
mu.ReqError.prototype = new Error();
mu.ReqError.prototype.constructor = mu.ReqError;
